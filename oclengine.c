...
{
	/* bn_expand is internal to OpenSSL, it's not clear what was tried here
       whether it was chopping off to 256 bits or ensuring it's 256 bits
	   but OpenSSL should take care of this automatically
	*/
	//bn_expand(bn, 256);
	memcpy(bn->d, buf, 32);
